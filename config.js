...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By KHADHER' : process.env.ALL_CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/4WTPnw9.jpeg' : process.env.GAN_IMAGE,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'KHADHER' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'COSMO' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/pM6CB1A.jpeg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/khadher05' : process.env.SOCIAL_MEDIA,
    ...
    SUPPORT: "917025191792-1627138839",
